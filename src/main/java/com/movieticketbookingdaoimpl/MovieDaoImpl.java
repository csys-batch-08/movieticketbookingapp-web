 ...
 */
	...
	public List<Movie> search( String moviename) 
	{
			    ...
			    try {
				    ...
				    mvproduct=new  Movie(resultset.getString(1),resultset.getInt(2),resultset.getString(3),resultset.getInt(4),resultset.getString(5),resultset.getString(6),resultset.getString(7),resultset.getString(8));
 ...
 */
		...
		public List<Movie> showMovie() {
			...
			try {
				...
				while(resultset.next()) {
				mvproduct=new  Movie(resultset.getString(1),resultset.getInt(2),resultset.getString(3),resultset.getInt(4),resultset.getInt(5),resultset.getString(6),resultset.getString(7),resultset.getString(8),resultset.getString(9),resultset.getString(10));
